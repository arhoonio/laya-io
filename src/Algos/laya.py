...
info = {
    ...
    "sollus" : {
        ...
        '10':  ["tha- tha- thari thari kita thaka thaka thari kita thaka", "ki ta tha ka tha ri ki ta thom -", "tha ri tha ri ki ta ki ta kum", "thari kita kita thaka naka"],
        
        '-': ["-"],
        '(1)': ["-"],
        '(2)': ["tham -", "dheem -", "dhin -", "dhi -", "- -"],
        '(3)': ["thaan - gu", "dheen - gu", "tham - -", "- - -"],
        '(4)': ["dhin - tha -", "tham - tham -", "dheem - dheem -", "- - - -"],
        '(5)': ["dhin - thaan - gu", "dhin - dheen - gu", "- - - - -"],
        '(6)': ["thaan - gu thaan - gu", "dheen - gu dheen - gu", "tham - tham - tham -"],
